...
export const ANNOUNCEMENTS: AnnouncementItem[] = [
  ...
  {
    id: 'ann-2',
    titleEn: 'Admissions Open: Madrasah Usman-e-Ghani Hifz & Nazra Quran',
    titleUr: 'نئے داخلے جاری: مدرسہ عثمانِ غنی برائے حفظ و ناظرہ قرآن کریم',
    category: 'education',
    date: '2026-08-26',
    hijriDate: '13 Safar 1448 AH',
    important: true,
    time: 'Morning Shift: 8:00 AM - 11:30 AM | Evening Shift: 4:30 PM - 7:30 PM',
    badgeEn: 'Admissions 2026',
    badgeUr: 'داخلے جاری ہیں',
    contentEn:
      'Admissions are open for new academic session in Hifz-ul-Quran (with Tajweed) and Nazra Quran with essential Masnoon Duas and basic Fiqh. Separate classes for boys and girls under certified Qaris and Aalima teachers.',
    contentUr:
      'جامع مسجد عثمان غنی کے زیر اہتمام شعبہ حفظ و ناظرہ قرآن مع تجوید و مسنون دعائیں نئے تعلیمی سال کے لیے داخلے شروع ہو چکے ہیں۔ طلباء و طالبات کے لیے الگ الگ باوقار اساتذہ کرام اور قراء حضرات کی نگرانی میں تعلیم کا بہترین انتظام۔',
  },
  {
    id: 'ann-3',
...
export const FACILITIES: FacilityItem[] = [
  ...
  {
    id: 'fac-2',
    titleEn: 'Dar-ul-Quran & Hifz Academy',
    titleUr: 'دارالقرآن و حفظ اکیڈمی',
    descriptionEn:
      'Formal Islamic education academy offering Tajweed, Hifz-e-Quran, Nazra, and basic Islamic manners for children and youth.',
    descriptionUr:
      'بچوں اور نوجوانوں کے لیے تجوید، حفظِ قرآن اور بنیادی دینی تربیت کا منظم اور سند یافتہ ادارہ۔',
    icon: 'BookOpen',
    tagEn: 'Morning & Evening',
    tagUr: 'صبح و شام اوقات',
    detailsEn: [
      'Certified Qaris from Jamia Darul Uloom Karachi',
      'Individual progress tracking and monthly parent reports',
      'Nazra Quran with Tajweed rules and correct Makharij',
      'Essential Masnoon Duas, Kalimas, and Fiqh of Salah',
    ],
    detailsUr: [
      'جامعہ دارالعلوم کراچی کے سند یافتہ اساتذہ کرام',
      'طلبہ کی انفرادی کارکردگی رپورٹ اور ماہانہ ٹیسٹ',
      'تجوید اور درست مخارج کے ساتھ ناظرہ قرآن',
      'مسنون دعائیں، کلمے اور بنیادی مسائلِ نماز',
    ],
  },
  {
    id: 'fac-3',
